...
class Imagem extends Grafico {
   ...
   */
  get altura() {
    return this.imagem.height * this.manipulaAltura;
  }
    ...
    if (this.visivel) {
      ...
      if (this.rotacao != 0) {
        ...
        contexto.drawImage(this.imagem, 
          this.indice * this.largura, 0, 
          this.largura, this.altura, 
          Math.floor(-this.largura * 0.5), Math.floor(-this.altura * 0.5), 
          this.largura, this.altura);
        contexto.restore();
      }
      else {
        contexto.drawImage(this.imagem, 
          this.indice * this.largura, this.altura * this.crop, 
          this.largura, this.altura, 
